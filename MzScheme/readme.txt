This is the MzScheme v372 executable package folder for Windows.

The following are the executables:

  MzScheme.exe -- a text-only Scheme interpreter
  mzc.exe -- command-line tool for creating executables, etc.
  Setup PLT.exe --- command-line setup tool
...
menu, or run Help Desk.exe.  Also, visit http://www.plt-scheme.org/.
